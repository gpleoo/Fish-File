...
const en = {
    ...
    analysis: {
        ...
        allWindSpeeds: 'all wind speeds',
        windCalm: 'calm (0-5 knots)',
        windLight: 'light (6-15 knots)',
        windModerate: 'moderate (16-25 knots)',
        windStrong: 'strong (>25 knots)',
        allPressures: 'all pressures',
        pressureLow: 'low (<1010 hPa)',
        pressureNormal: 'normal (1010-1020 hPa)',
        pressureHigh: 'high (>1020 hPa)',
